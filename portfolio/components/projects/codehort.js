  ...
  const playSound = () => {
    ...
    return (
        <div className={styles.root} ref={rootRef}>
            ...
            {isMobile ? <Image src={Codehort_main} style={{ width: '90%', height: '100px', margin: '10px'}} alt='codehort sample image'/> : <Image src={Codehort_main} style={{ width: '90%', height: '200px', margin: '10px'}} alt='codehort sample image'/> }
        </div>
    )
}
