    ...
    return (
        <div className={styles.contact} id='contact'>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                <label>Name: <input onChange={(e) => setName(e.target.value)} required></input></label>
                ...
                <div className={styles.OAuth}>
                    ...
                    <button onClick={() => signIn('github')}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-github" viewBox="0 0 16 16">
